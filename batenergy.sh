...
echo "Processing ${SYSTEMD_SLEEP_ACTION}."
echo "Called with '${state}', '${sleep_type}'."

case ${state} in
("pre")
	echo "Saving time and battery energy before sleeping."
	echo ${now} > ${FILE}
...
("post")
	...
	echo "Duration of ${days} days ${hours} hours ${minutes} minutes sleeping."
